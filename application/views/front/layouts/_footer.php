      ...
      <div class="row f_widgets_inner">
         <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="single-footer-widget ab_widgets">
               <div class="f_title">
                  <h3>Korps Pers Mahasiswa (KPM)</h3>
               </div>
               <p>Korps Pers Mahasiswa (KPM) merupakan portal berita kekinian</p>
            </div>
         </div>
         <div class="col-lg-4 col-md-6 col-sm-6">
...
Copyright Korps Pers Mahasiswa &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved
